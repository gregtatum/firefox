...
add_task(async function test_rapid_mutation_after_initial_translation() {
  ...
  await htmlMatches(
    ...
    /* html */ `
      <div title="M̅u̅t̅a̅t̅i̅o̅n̅ 5 o̅n̅ t̅i̅t̅l̅e̅ (id:4)">
        M̅u̅t̅a̅t̅i̅o̅n̅ 5 o̅n̅ e̅l̅e̅m̅e̅n̅t̅ (id:3)
      </div>
    `,
    document,
    resolveRequests
...
add_task(async function test_rapid_mutation_before_initial_translation() {
  ...
  await htmlMatches(
    "The changed node gets translated",
    /* html */ `
      <div title="M̅u̅t̅a̅t̅i̅o̅n̅ 5 o̅n̅ t̅i̅t̅l̅e̅ (id:2)">
        M̅u̅t̅a̅t̅i̅o̅n̅ 5 o̅n̅ e̅l̅e̅m̅e̅n̅t̅ (id:1)
      </div>
    `,
    document,
    resolveRequests
